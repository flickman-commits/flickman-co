...
export default function MoneyDinnersPage() {
  return (
    <main className="md">
      ...
      {/* Problem */}
      <section className="md-wrap md-section">
      ...
      {/* Form */}
      <section className="md-wrap md-section" id="join">
...
.md-logo { font-weight: 800; font-size: 20px; letter-spacing: -0.6px; }
...
.md-label { font-size: 13px; font-weight: 600; letter-spacing: 2.4px; text-transform: uppercase;
  color: var(--label); margin-bottom: 18px; }

.md-hero-band { position: relative; overflow: hidden; padding-bottom: 40px; }
...
.md-ig a { color: var(--ink); text-decoration: none; border-bottom: 3px solid var(--orange); }
...
.md-lede { font-size: clamp(18px, 2.3vw, 21px); font-weight: 500; color: var(--ink2);
  line-height: 1.55; max-width: 600px; margin: 24px 0 0; }

.md-section { padding-top: 88px; }
...
.md-cta { margin-top: 34px; }
.md-btn { display: inline-block; background: var(--ink); color: #fff; font-weight: 700;
  font-size: 17px; text-decoration: none; border: none; border-radius: 12px;
  padding: 16px 30px; cursor: pointer; font-family: inherit; transition: transform 120ms ease, background 120ms ease; }
.md-btn:hover { transform: translateY(-2px); background: #000; }
.md-btn:disabled { opacity: 0.6; cursor: default; transform: none; }
.md-btn-full { width: 100%; margin-top: 6px; }
.md-cta-note { display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600;
  color: var(--ink2); margin-top: 12px; }
.md-cta-note::before { content: ""; width: 9px; height: 9px; border-radius: 50%; background: var(--orange); }

.md-rows { list-style: none; padding: 0; margin: 0; border-top: 1px solid var(--hair); }
.md-rows li { font-size: clamp(18px, 2.4vw, 22px); font-weight: 500; line-height: 1.4;
  padding: 20px 0; border-bottom: 1px solid var(--hair); }
.md-punch { font-size: clamp(20px, 2.6vw, 24px); font-weight: 800; letter-spacing: -0.5px;
  line-height: 1.35; margin: 28px 0 0; }

.md-story { border-left: 4px solid var(--orange); padding-left: 24px; }
.md-story p { font-size: 18px; line-height: 1.65; margin: 0 0 16px; font-weight: 500; color: var(--ink2); }
.md-story strong { color: var(--ink); }
.md-story .md-story-punch { font-weight: 800; font-size: 21px; color: var(--ink); letter-spacing: -0.3px; }
.md-sig { font-size: 15px; font-weight: 600; color: var(--muted); }
...
.md-list li { display: flex; gap: 20px; padding: 20px 0; border-bottom: 1px solid var(--hair); }
.md-list-num { font-size: 14px; font-weight: 700; color: var(--label); letter-spacing: 1px; padding-top: 4px; min-width: 24px; }
.md-list h3 { margin-bottom: 4px; }
.md-list p { margin: 0; color: var(--ink2); line-height: 1.55; font-weight: 500; font-size: 16px; }
.md-bonus { font-size: 16px; font-weight: 500; line-height: 1.55; color: var(--ink2); margin: 16px 0 0;
  padding: 14px 16px; border: 2px dashed var(--orange); border-radius: 14px; }
.md-bonus strong { color: var(--ink); }
.md-steps-after { margin-top: 16px; border-top: none; }
.md-steps li { display: flex; gap: 22px; padding: 24px 0; border-bottom: 1px solid var(--hair); }
.md-num { font-size: 40px; font-weight: 800; color: var(--orange); line-height: 1; min-width: 32px; }
.md-steps p { margin: 0; color: var(--ink2); line-height: 1.6; font-weight: 500; font-size: 16px; }

.md-fit { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 40px; }
.md-checks, .md-crosses { list-style: none; padding: 0; margin: 0; }
.md-checks li, .md-crosses li { padding: 14px 0 14px 32px; position: relative; line-height: 1.5;
  font-weight: 500; font-size: 16px; border-bottom: 1px solid var(--hair); }
.md-checks li::before { content: "✓"; color: var(--green); font-weight: 800; position: absolute; left: 4px; }
.md-crosses li { color: var(--ink2); }
.md-crosses li::before { content: "✕"; color: var(--label); font-weight: 800; position: absolute; left: 4px; }

.md-prices { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px; }
.md-price { position: relative; background: #fff; border: 1px solid var(--hair); border-radius: 18px; padding: 28px 24px 24px; }
.md-price p { margin: 0; color: var(--ink2); font-weight: 500; line-height: 1.5; }
.md-price-best { border: 2px solid var(--orange); }
.md-badge { position: absolute; top: -13px; left: 20px; background: var(--orange); color: var(--ink);
  font-size: 11px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase;
  padding: 5px 10px; border-radius: 6px; }
.md-amount { font-size: 48px; font-weight: 800; letter-spacing: -1.8px; margin: 6px 0 10px; }
.md-amount span { font-size: 17px; color: var(--muted); font-weight: 600; letter-spacing: 0; }

.md-proof { font-size: 18px; line-height: 1.6; font-weight: 500; margin: 0 0 28px; color: var(--ink2); }
.md-stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 24px; }
.md-stats div { border-top: 4px solid var(--orange); padding-top: 14px; }
.md-stats strong { display: block; font-size: 44px; font-weight: 800; letter-spacing: -1.8px; line-height: 1.05; }
.md-stats span { font-size: 14px; font-weight: 500; color: var(--muted); }

.md-join { border: 3px dashed var(--orange); border-radius: 28px; padding: clamp(24px, 5vw, 44px); }
.md-form { display: grid; gap: 18px; }
.md-form label { display: grid; gap: 8px; font-size: 15px; font-weight: 700; }
.md-form input, .md-form select { width: 100%; font: inherit; font-size: 16px; font-weight: 500;
  color: var(--ink); background: #fff; border: 1px solid var(--hair); border-radius: 12px;
  padding: 14px 15px; outline: none; transition: border-color 120ms ease; }
.md-form input::placeholder { color: var(--label); }
.md-form input:focus, .md-form select:focus { border-color: var(--ink); }
.md-why { font-size: 14px; line-height: 1.55; color: var(--ink2); margin: 0; font-weight: 500;
  padding: 14px 16px; background: var(--track); border-radius: 12px; }
.md-why strong { color: var(--ink); }
.md-form-note { font-size: 13px; font-weight: 600; color: var(--muted); text-align: center; }
.md-err { color: #C0392B; }

.md-done { background: var(--green); color: #fff; border-radius: 18px; padding: 28px 26px; }
.md-done-title { font-size: 28px; font-weight: 800; letter-spacing: -0.8px; }
.md-done p { color: var(--green-soft); font-weight: 600; margin: 6px 0 0; font-size: 16px; }

.md-foot { text-align: center; font-size: 13px; font-weight: 600; color: var(--label);
  padding: 80px 20px 48px; letter-spacing: 0.3px; }
`;
